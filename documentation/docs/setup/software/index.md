...
- `planktoscopehat`: this configuration of the PlanktoScope distro is compatible with all versions of the PlanktoScope hardware starting with hardware v2.3; those hardware versions use a custom HAT. Note that in software versions v2.3 and v2023.9.0, this was called `pscopehat` instead of `planktoscopehat`.
